      ...
      body: Container(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              SizedBox(height: 25),
              TextField(hintText: "Course title", inputType: TextInputType.text),
              SizedBox(height: 15),
              TextField(
                  hintText: "Course category", inputType: TextInputType.text),
              SizedBox(height: 15),
              TextField(hintText: "Description", inputType: TextInputType.text),
              SizedBox(height: 15),
              TextField(hintText: "Course link", inputType: TextInputType.url),
              SizedBox(height: 25),
              Btn(
                  text: "Save details",
                  onPressed: () {
